...
public class UserAddress {
	...
	private int pincode;
	@OneToOne(mappedBy="useraddress",cascade=CascadeType.PERSIST)
	...
	public UserAddress(int addressId, String address1, String address2, String city, String state, int pincode) {
		super();
